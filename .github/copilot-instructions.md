...
# 科研工作区 Copilot Bootstrap

本文件是 Copilot 入口层，不是主规则库。真正的 agent 系统只在 `.agent/`。

## 工作区定位

- 这是科研管理工作区，不是默认软件开发仓库
...
- `.github/copilot-instructions.md` 只保留 bootstrap，不再承载完整规则、画像镜像、handoff 或 workflow 正文
- 更新 agent 结构后，运行：
